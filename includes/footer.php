<footer class="bg-[#061a33] text-gray-400 pt-20 pb-10">
  <div class="max-w-7xl mx-auto px-6 md:px-10">
    ...
    <div class="grid grid-cols-1 md:grid-cols-5 gap-16">
      ...
      <div class="md:col-span-2 flex flex-col items-start justify-start">
        ...
        <p class="text-white text-xl font-semibold leading-snug text-left w-full">
      ...
      <div>
        ...
        <ul class="space-y-5 text-gray-400">
          ...
          <li><a href="#" class="hover:text-white transition">For Students</a></li>
          <li><a href="#" class="hover:text-white transition">For Recruiters</a></li>
          <li><a href="#" class="hover:text-white transition">Why NIT Sikkim?</a></li>
        </ul>
      </div>
      ...
      <div>
        ...
        <ul class="space-y-5 text-gray-400">
          ...
          <li><a href="#" class="hover:text-white transition">Placement Brochure</a></li>
          <li><a href="#" class="hover:text-white transition">Training Calendar</a></li>
        </ul>
      </div>
    ...
    <!-- DIVIDER -->
    <div class="border-t border-gray-700 mt-16 pt-8 flex flex-col md:flex-row items-center justify-between">
      <!-- COPYRIGHT -->
      <p class="text-sm text-gray-500 text-center md:text-left">
        © 2024 NIT Sikkim T&P Cell. All rights reserved.
      </p>
